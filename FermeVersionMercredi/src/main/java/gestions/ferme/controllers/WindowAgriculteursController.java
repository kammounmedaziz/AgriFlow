...
public class WindowAgriculteursController {
    ...
    void saveUser(ActionEvent event) {
        try {
            ...
            if (exists) {
                ...
                utilisateur.setRole("fermier(e)");
                service.ajouterEntityFermier(utilisateur);
            }
    ...
    void showAddUserForm(ActionEvent event) {
        ...
        formTitle.setText("Ajouter un nouvel agriculteur");
    ...
    void showEditUserForm(ActionEvent event) {
        ...
        if (selected != null) {
            ...
            formContainer.setVisible(true);
            formTitle.setText("Modifier l'agriculteur");
    ...
    @FXML
    void initialize() {
        assert BtnRetourAccueil != null : "fx:id=\"BtnRetourAccueil\" was not injected: check your FXML file 'userAgricul.fxml'.";
        assert addButton != null : "fx:id=\"addButton\" was not injected: check your FXML file 'userAgricul.fxml'.";
        assert adminCountLabel != null : "fx:id=\"adminCountLabel\" was not injected: check your FXML file 'userAgricul.fxml'.";
        assert deleteButton != null : "fx:id=\"deleteButton\" was not injected: check your FXML file 'userAgricul.fxml'.";
        assert editButton != null : "fx:id=\"editButton\" was not injected: check your FXML file 'userAgricul.fxml'.";
        assert emailCol != null : "fx:id=\"emailCol\" was not injected: check your FXML file 'userAgricul.fxml'.";
        assert emailField != null : "fx:id=\"emailField\" was not injected: check your FXML file 'userAgricul.fxml'.";
        assert formContainer != null : "fx:id=\"formContainer\" was not injected: check your FXML file 'userAgricul.fxml'.";
        assert formTitle != null : "fx:id=\"formTitle\" was not injected: check your FXML file 'userAgricul.fxml'.";
        assert idCol != null : "fx:id=\"idCol\" was not injected: check your FXML file 'userAgricul.fxml'.";
        assert nomCol != null : "fx:id=\"nomCol\" was not injected: check your FXML file 'userAgricul.fxml'.";
        assert nomField != null : "fx:id=\"nomField\" was not injected: check your FXML file 'userAgricul.fxml'.";
        assert passwordField != null : "fx:id=\"passwordField\" was not injected: check your FXML file 'userAgricul.fxml'.";
        assert prenomCol != null : "fx:id=\"prenomCol\" was not injected: check your FXML file 'userAgricul.fxml'.";
        assert prenomField != null : "fx:id=\"prenomField\" was not injected: check your FXML file 'userAgricul.fxml'.";
        assert sexeCol != null : "fx:id=\"sexeCol\" was not injected: check your FXML file 'userAgricul.fxml'.";
        assert sexeField != null : "fx:id=\"sexeField\" was not injected: check your FXML file 'userAgricul.fxml'.";
        assert telephoneCol != null : "fx:id=\"telephoneCol\" was not injected: check your FXML file 'userAgricul.fxml'.";
        assert telephoneField != null : "fx:id=\"telephoneField\" was not injected: check your FXML file 'userAgricul.fxml'.";
        assert totalUsersLabel != null : "fx:id=\"totalUsersLabel\" was not injected: check your FXML file 'userAgricul.fxml'.";
        assert userTable != null : "fx:id=\"userTable\" was not injected: check your FXML file 'userAgricul.fxml'.";
        ...
        List<Utilisateur> utilisateurs = service.getAllDataFermier();
    ...
    private void chargerTable() {
        ...
        ObservableList<Utilisateur> liste = FXCollections.observableArrayList(service.getAllDataFermier());
